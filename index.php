        ...
        <div class="footer">
            ...
            <div class="footer content">
                ...
                <form method="post" action="index.php" id='contact-form'>
                    ...
                    <label for="" name='sender'><p>Name</p></label>
                    <input type="text" name='sender' placeholder='Jane Doe'>

                    <label for="" name='sender-email'><p>Email</p></label>
                    <input type="email" name='senderEmail' placeholder='jane-doe@gmail.com'>

                    <label for="" name='message'><p>Message:</p></label>
...
//                }
                $.ajax({
                    ...
                    success: function(msg) {
                        $('<p> Thanks!  Your message has been sent!</p>').insertAfter('#submit');
                    }
                });
            });
